...
class CustomModal {
    ...
    static showYesNoHrefModal(unique_caller,
                              href_url,
                              modal_title,
                              modal_body) {
        let modal_template =
            `<div class="modal fade" id="${unique_caller}Modal" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">${modal_title}</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-dark rounded-pill"
                                    data-dismiss="modal"
                                    onclick="location.href='${href_url}'">
                                Ya
                            </button>
                        </div>
                    </div>
...
$(document).ready(() => {
    ...
    CustomModal.showYesNoHrefModal("logoutBtn",
        logout_url,
        "Konfirmasi Logout",
        "Logout Sekarang?")
